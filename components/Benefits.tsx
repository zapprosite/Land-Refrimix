...
const BenefitCard: React.FC<{ icon: string; title: string; children: React.ReactNode }> = ({
  icon,
  title,
  children,
}) => (
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-light-fg/80 dark:text-dark-fg/80">
            Entregamos mais do que ar condicionado, proporcionamos bem-estar.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <BenefitCard icon="fa-cogs" title="Tecnologia de Ponta">
            Trabalhamos com os sistemas VRV/VRF mais avançados do mercado, garantindo performance e
            controle total do seu ambiente.
          </BenefitCard>
          <BenefitCard icon="fa-leaf" title="Eficiência Energética">
            Nossas soluções são projetadas para reduzir o consumo de energia, gerando economia e
            sustentabilidade para seu projeto.
          </BenefitCard>
          <BenefitCard icon="fa-shield-alt" title="Confiabilidade e PMOC">
            Equipe certificada e planos de manutenção (PMOC) que asseguram a longevidade e a
            qualidade do ar em seus equipamentos.
          </BenefitCard>
        </div>
      </div>
    </section>
